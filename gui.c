...
static void activate (GtkApplication* app, gpointer user_data)
 {
    ...
    lastnamelabel = gtk_label_new("your last name:");

    lastname = gtk_entry_new();
     gtk_entry_set_placeholder_text(GTK_ENTRY(lastname),"your last name");

     usernamelabel = gtk_label_new("your username:"); 
    
     username = gtk_entry_new();
     gtk_entry_set_placeholder_text(GTK_ENTRY(username),"your username");

     passlab = gtk_label_new("your password:"); 

    userpass = gtk_entry_new();
     gtk_entry_set_placeholder_text(GTK_ENTRY(userpass),"your password");
     gtk_entry_set_visibility(GTK_ENTRY(userpass),FALSE);

    adduser = gtk_button_new_with_label("sing in");
